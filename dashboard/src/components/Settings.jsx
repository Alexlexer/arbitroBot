    ...
    <div className="p-6 max-w-6xl mx-auto min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        <div className="lg:col-span-1 space-y-2">
          <h2 className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-4 px-2">Active Exchanges</h2>
          {activeExchanges.length === 0 ? (
            <p className="text-slate-500 text-sm px-2">Enable at least one exchange in Dashboard → Bot Control.</p>
          ) : (
